...
import by.incubator.application.parser.IBreakingsParser;
...
public class ParserBreakingsFromFile implements IBreakingsParser {
    ...
    public boolean findBrokenVehicle(Vehicles vehicle) {
